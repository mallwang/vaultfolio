...
/**
 * Account Overview placeholder page (022-add-domain-placeholders, FR-003):
 ...
 */
@Component({
  selector: 'app-account-overview-placeholder',
  imports: [CardModule, TranslatePipe],
  template: `
    <p-card>
      <div class="placeholder">
        <strong>{{ 'accountOverviewPlaceholder.title' | translate }}</strong>
        <p>{{ 'accountOverviewPlaceholder.body' | translate }}</p>
      </div>
    </p-card>
  `,
  styles: `
...
export class AccountOverviewPlaceholderComponent {}
