...
export const de: TranslationDictionary = {
  ...
  acceptInvite: {
    ...
    lede: 'Sie wurden eingeladen, einem Vaultfolio-Haushalt als {{role}} beizutreten. Wählen Sie ein Passwort, um Ihr Konto zu aktivieren.',
    roleAdmin: 'Administrator',
    roleMember: 'Mitglied',
    nameLabel: 'Ihr Name',
    passwordLabel: 'Passwort',
    passwordPlaceholder: '8–200 Zeichen',
    passwordHint: 'Die gleichen Passwortregeln wie überall sonst in Vaultfolio.',
    confirmPasswordLabel: 'Passwort bestätigen',
    submit: 'Konto aktivieren',
    nameRequiredError: 'Bitte geben Sie Ihren Namen ein.',
    passwordsDoNotMatchError: 'Die Passwörter stimmen nicht überein.',
    passwordLengthError: 'Das Passwort muss 8–200 Zeichen lang sein.',
    genericError: 'Das Konto konnte nicht aktiviert werden. Bitte erneut versuchen.',
  },
  forgotPassword: {
