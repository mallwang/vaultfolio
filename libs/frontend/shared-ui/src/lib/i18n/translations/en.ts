...
export const en: TranslationDictionary = {
  ...
  acceptInvite: {
    ...
    lede: "You've been invited to join a Vaultfolio household as {{role}}. Choose a password to activate your account.",
    roleAdmin: 'an Administrator',
    roleMember: 'a Member',
    nameLabel: 'Your name',
    passwordLabel: 'Password',
    passwordPlaceholder: '8–200 characters',
    passwordHint: 'Same password rules as everywhere else in Vaultfolio.',
    confirmPasswordLabel: 'Confirm password',
    submit: 'Activate account',
    nameRequiredError: 'Please enter your name.',
    passwordsDoNotMatchError: 'Passwords do not match.',
    passwordLengthError: 'Password must be 8–200 characters.',
    genericError: 'Unable to activate this account. Please try again.',
  },
  forgotPassword: {
